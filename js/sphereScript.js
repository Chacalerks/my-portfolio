...
renderer.setClearColor(0xA0A0F, 1); // Set the background color to white
...
let material = new THREE.MeshBasicMaterial({
    color: 0x33A1D4, transparent: true,
...
document.addEventListener('mousemove', function (e) {
    ...
    if (isDragging) {
        ...
        texts.forEach(text => {
            ...
            if (dotProduct < 0) {
                text.material.opacity = THREE.MathUtils.lerp(text.material.opacity, 0.08, 0.05);
